# Aromista - Frontend (Coffee Management System)
...
- **Smooth UI:** Glassmorphism design with Framer Motion animations.
- **Shopping Cart:** Real-time cart management using React Context.
- **Product Filtering:** Browse coffee items by category.
